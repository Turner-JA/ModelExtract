...
obs.no=nobs(Mod)
if(showFormula==T){
formula=format(Fren_NFS_Mod_F2@call[["formula"]])
nrows=nrow(datOut)
...
datOut[nrows+1, 1]=paste(datOut[nrows+3, 1], "; ", RanEfsString1, "( ", nobsGrp, ", Var = ", RanEfsString2, ", SD = ", RanEfsString3, ")", sep ="")
}
}
}
...
if (i==1){
  ...
  datOut[nrows+1, 1]=paste(datOut[nrows+4, 1], "; ", RanSlopes1, " by ", RanSlopes2, " (Var = ", RanSlopes3, ", SD =", RanSlopes4, ")", sep ="")
}
}}
